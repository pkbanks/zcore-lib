...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/zcore-lib.min.js"></script>
...
```sh
browserify --require ./index.js:zcore-lib | uglifyjs > zcore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external zcore-lib | uglifyjs > bitcore-mnemonic.min.js
```
